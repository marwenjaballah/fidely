  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="text-center mb-8 space-y-2">
        <h1 className="text-2xl sm:text-3xl font-bold text-foreground">{strings.auth_signup_success_title}</h1>
        <p className="text-sm text-muted-foreground">{strings.auth_signup_success_description}</p>
      </div>
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <p className="text-sm text-muted-foreground text-center leading-relaxed">
          {strings.auth_signup_success_help}
        </p>
